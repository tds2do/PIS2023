...
public class formUsuarioEdit extends javax.swing.JFrame {
    ...
    public void getDatosUsuario(){
        ...
        usu = UsuarioDAO.leer(Integer.valueOf(idUsuario));
        
        txtCedula.setText(usu.getCedula());
        txtCodigoEmpleado.setText(usu.getCodigoEmpleado());
        txtPrimerNombre.setText(usu.getPrimerNombre());
        txtSegundoNombre.setText(usu.getSegundoNombre());
        txtPrimerApellido.setText(usu.getPrimerApellido());
        txtSegundoApellido.setText(usu.getSegundoApellido());
        txtDepartamento.setText(usu.getDepartamento());
        txtCargo.setText(usu.getCargo());
        //txtFechaNacimiento.setText(usu.getFechaNacimiento());
