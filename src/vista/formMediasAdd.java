 ...
 */
public class formMediasAdd extends javax.swing.JFrame {

    /**
     * Creates new form MediasAdd
     */
    public formMediasAdd() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("REGISTRAR MEDIDAS");
    ...
    public static void main(String args[]) {
        ...
        {
            java.util.logging.Logger.getLogger(formMediasAdd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formMediasAdd().setVisible(true);
            }
        });
    }
