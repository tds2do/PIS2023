 ...
 * @author Jonathan
 */
public class formMedidaAdd extends javax.swing.JFrame {

    Usuario sysUser;
    /**
     * Creates new form formUsuarioAdd
     */
    public formMedidaAdd() {
        initComponents();
        this.setLocationRelativeTo(null);
    }

    public formMedidaAdd(Usuario user) {
        initComponents();
        this.sysUser = user;
        this.setLocationRelativeTo(null);
    }
    ...
    private void btnGuardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardar1ActionPerformed
        ...
        if(!txtAbreviatura.getText().equals("") && 
            ...
            medi.setDescripcion((String)txtDescripcion.getText());
                        ...
                        medi.setEstado(1);
                        medi.setFechaIngreso(LocalDateTime.now());
                        medi.setUsuarioIngreso(sysUser.getUsername());
                            
                        if(cliDAO.registrar(medi)){                           
                            this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formMedidaAdd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formMedidaAdd().setVisible(true);
            }
        });
    }
