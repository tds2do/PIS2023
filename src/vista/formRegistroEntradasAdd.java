 ...
 * @author Jonathan
 */
public class formRegistroEntradasAdd extends javax.swing.JFrame {

    Usuario sysUser;
    /**
     * Creates new form formUsuarioAdd
     */
    public formRegistroEntradasAdd() {
        initComponents();
        this.setLocationRelativeTo(null);
    }

    public formRegistroEntradasAdd(Usuario user) {
        initComponents();
        this.sysUser = user;
        this.setLocationRelativeTo(null);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formRegistroEntradasAdd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formRegistroEntradasAdd().setVisible(true);
            }
        });
    }
