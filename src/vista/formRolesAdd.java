 ...
 */
public class formRolesAdd extends javax.swing.JFrame {

    /**
     * Creates new form formRolesAdd
     */
    public formRolesAdd() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        {
            java.util.logging.Logger.getLogger(formRolesAdd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formRolesAdd().setVisible(true);
            }
        });
    }
